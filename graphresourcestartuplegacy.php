    ...
    <div style="text-align: left">
        <form action="graphresourceurl.php" method="get">
            ...
            if (in_array("bigbluebuttonbn", $availableModules)) {
                echo block_analytics_graphs_generate_graph_startup_module_entry($legacypixurlbefore . $OUTPUT->pix_url('icon',
                    'mod_bigbluebuttonbn') . $legacypixurlafter, "mod" . $num, "bigbluebuttonbn",
